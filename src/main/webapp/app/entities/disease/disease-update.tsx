...
export class DiseaseUpdate extends React.Component<IDiseaseUpdateProps, IDiseaseUpdateState> {
  ...
  render() {
    const { diseaseEntity, drugs, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="drugstoreApp.disease.home.createOrEditLabel">
              <Translate contentKey="drugstoreApp.disease.home.createOrEditLabel">Create or edit a Disease</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
