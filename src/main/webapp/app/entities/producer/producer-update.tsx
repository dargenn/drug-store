...
export class ProducerUpdate extends React.Component<IProducerUpdateProps, IProducerUpdateState> {
  ...
  render() {
    const { producerEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="drugstoreApp.producer.home.createOrEditLabel">
              <Translate contentKey="drugstoreApp.producer.home.createOrEditLabel">Create or edit a Producer</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
